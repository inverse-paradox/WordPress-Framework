						...
						<table class="widefat ipf-input">
							<tbody>
								...
								<tr class="field-args-query_var">
									...
									<td class="input">
										<label><input type="radio" value="true" name="options[<?php echo $taxonomy['id']; ?>][args-query_var]" <?php if ($taxonomy['args']['query_var'] == 'true') echo 'checked="checked"'; ?> /> True</label><br />
										<label><input type="radio" value="false" <?php if ($taxonomy['args']['query_var'] == 'false') echo 'checked="checked"'; ?> /> False</label><br />
										<label><input type="radio" value="string" <?php if ($taxonomy['args']['query_var'] == 'string') echo 'checked="checked"'; ?> /> String</label>
									</td>
								</tr>
								<tr class="field-args-update_count_callback">
									<td class="label">
										<label>Update Count Callback</label>
										<p>A function name that will be called to update the count of an associated $object_type, such as post, is updated.</p>
									</td>
									<td class="input">
			...
			<tfoot>
				<tr>
					<th colspan="3" class="submit">
						<button id="add-row" class="button-primary">Add New Custom Taxonomy</button>
