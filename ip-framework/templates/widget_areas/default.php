			...
			<tfoot>
				<tr>
					<th colspan="2" class="submit">
						<button id="add-row" class="button-primary">Add New Sidebar</button>
			...
			<table class="widefat ipf-input">
				<tbody>
					...
					<tr class="field-before_widget">
						...
						<td class="input">
							<input type="text" value="<li id=&quot;%1$s&quot; class=&quot;widget %2$s&quot;>" />
						</td>
					</tr>
					<tr class="field-after_widget">
						<td class="label">
					...
					<tr class="field-before_title">
						...
						<td class="input">
							<input type="text" value="<h2 class=&quot;widgettitle&quot;>" />
						</td>
					</tr>
					<tr class="field-after_title">
						<td class="label">
