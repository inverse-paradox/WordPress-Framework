						...
						<table class="widefat ipf-input">
							<tbody>
								...
								<tr class="field-args-has_archive">
									...
									<td class="input">
										<label><input type="radio" value="true" name="options[<?php echo $post_type['id']; ?>][args-has_archive]" <?php if ($post_type['args']['has_archive'] === true) echo 'checked="checked"'; ?> /> True</label><br />
										<label><input type="radio" value="false" name="options[<?php echo $post_type['id']; ?>][args-has_archive]" <?php if ($post_type['args']['has_archive'] === false) echo 'checked="checked"'; ?> /> False</label>
									</td>
								</tr>
								<tr class="field-args-query_var">
									...
									<td class="input">
										...
										<label><input type="radio" value="string" <?php if (is_string($post_type['args']['query_var'])) echo 'checked="checked"'; ?> /> String</label>
									</td>
								</tr>
								<tr class="field-submit">
									<td class="label"></td>
			...
			<tfoot>
				<tr>
					<th colspan="4" class="submit">
						<button id="add-row" class="button-secondary">+ Add New Custom Post Type</button>
